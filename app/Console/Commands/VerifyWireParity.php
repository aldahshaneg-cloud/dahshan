...
class VerifyWireParity extends Command
{
    ...
    private const INTENTIONAL_FIELDS = [
        ...
        'pilots' => [
            ...
            'heading' => 'اتجاه حركة الطيار بالدرجات من آخر نقطة — اتضاف 2026-09-07 مع التتبّع الحي (طلب صاحب النظام: «الطيار بيثبت في مكان على الخريطة ومش بيظهر بشكل جيد»). سهم الاتجاه على الماركر.',
            'speed'   => 'سرعة الطيار م/ث من آخر نقطة — نفس السبب',
            'trail'   => 'أثر آخر دقيقتين [{lat,lng,t}] — بيتحقن بس لما اللوحة تطلب ?trail=1، والخريطة بتزحلق الماركر على النقاط دي بدل ما ينطّ. الأصل كان بيبعت نقطة واحدة كل دقيقة.',
        ],
        'users' => [
            ...
            'canTrackPilot' => 'خاصية تتبّع الطيار على الخريطة من بوابة المحل وهو جاي يستلم — اتضافت 2026-09-16 بطلب صاحب النظام: «تتبّع لبوابة المحلات للمندوب اللي هيجي يرفع منها وتبقى خاصية تتفتح وتتقفل»',
        ...
        'store_contacts' => [
            ...
            'lat' => 'دبوس التسليم المحفوظ مع العميل في دفتر المحل — اتضاف 2026-09-22 بطلب صاحب النظام: «إذا اختار من القائمة يجب أن يملأ كل الأماكن التي تخص العنوان المحفوظ». الأصل مكانش بيحفظ نقطة الخريطة مع جهة الاتصال.',
            'lng' => 'خط الطول لنفس الدبوس',
        ],
    ];
