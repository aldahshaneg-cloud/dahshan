...
class RouteCoverage extends Command
{
    ...
    private const INTENTIONAL_ADDITIONS = [
        ...
        /* 💵 سلف ومرتبات الطيارين من خزنة الفرع + صفحة المالية في التطبيق (طلب 2026-09-13) */
        'GET /api/pilot-accounting/pilot-cash' =>
            'عمليات الطيارين النقدية في فترة (سلف من الخزنة · سلف الورديات · صرف مرتبات) — صفحة حسابات الفرع',
        'POST /api/pilot-accounting/pilot-cash' =>
            'سلفة أو دفعة مرتب لطيار من خزنة الفرع — حركة منصرف + صف في السلف المؤجلة (قسط صفر) أو الصرفات',
        'DELETE /api/pilot-accounting/pilot-cash/{}/{}' =>
            'إلغاء سلفة/صرفة — الفلوس ترجع للخزنة بحركة وارد؛ مشرف الفرع على اللي سجّله هو بس',
        'GET /api/pilot/finance' =>
            'صفحة «المالية» في تطبيق الطيار: أيام الشهر وساعاته وأوردراته وعمولته والسلف والخصومات والمكافآت والصرف',
        'GET /api/rd/archive' =>
        ...
        'POST /api/users/{}/track-pilot' =>
            'فتح/قفل تتبّع الطيار من بوابة المحل لمحل بعينه (طلب 2026-09-16) — الافتراضي مقفول',
        'GET /api/store/orders/{}/pickup-track' =>
            'موقع الطيار اللي جاي يستلم من المحل — للمحل المفتوح له التتبّع، وقت الشيل بس (طلب 2026-09-16)',
