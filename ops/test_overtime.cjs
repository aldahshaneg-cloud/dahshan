...
/* 2026-09-21: السطر الصغير «+x إضافي» تحت الساعات بقى **عمود لوحده** (طلب صاحب النظام) */
ok('وجدولا الطيارين والموظفين بيوروا الإضافي في عمود لوحده',
  (A.match(/font-weight:700">\$\{ paMoney\(t\.overtimeHours\) \}<\/td>/g) || []).length === 2,
