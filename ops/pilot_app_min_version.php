...
$new['message'] = "نسخة جديدة من تطبيق الطيار {$ver}: الأزرار والتوقيتات اتظبطت، تنبيه فوري لو الـGPS مقفول، والوردية بتتزامن مع الفرع أول ما تفتح التطبيق. حدّث عشان تكمّل شغلك — لو التثبيت مش راضي يكمّل نزّل نسخة 32 بت من موقع aldahshan.cloud";
