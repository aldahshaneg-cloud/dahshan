...
$new['message'] = "نسخة جديدة من تطبيق الطيار {$ver}: صفحة «المالية» (ساعاتك وأوردراتك وعمولتك وسلفك وصافي شهرك)، الأزرار والتوقيتات اتظبطت، تنبيه فوري لو الـGPS مقفول، والوردية بتتزامن مع الفرع أول ما تفتح التطبيق. لو معاك 2.5.8 أو أحدث حدّث فوقها عادي. لو أقدم من 2.5.8: امسح التطبيق القديم الأول (الإعدادات ← التطبيقات ← الدهشان ← إلغاء التثبيت) وبعدين نزّل الجديد وركّبه وسجّل دخول تاني، ولو ظهرت رسالة Google Play للحماية اضغط «مزيد من التفاصيل» ثم «التثبيت على أي حال». لو التثبيت مش راضي يكمّل نزّل نسخة 32 بت من موقع aldahshan.cloud";
